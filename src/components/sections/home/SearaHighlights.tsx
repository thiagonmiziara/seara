          ...
          <div className='md:flex md:h-full'>
            ...
            <div className='relative p-8 flex flex-col justify-center md:w-2/3 md:h-full z-10'>
              <div className='mb-4 flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 w-fit'>
                ...
                <span className='text-[10px] font-bold uppercase tracking-widest text-primary/80'>Podcast</span>
              </div>
              ...
              <CardDescription className='text-muted-foreground mb-6 text-lg'>
                Ouça as mensagens que Deus tem para você através das pregações mais recentes.
              </CardDescription>
              ...
              <div className='mt-auto'>
                ...
                >
                  <Link href={"https://open.spotify.com/show/6QPChnlwCA8XSkf90TSIz8"} target='_blank'>
                    Ouvir Agora <Headphones className='ml-2 h-4 w-4 transition-transform duration-300 group-hover/btn:scale-110' />
                  </Link>
                </Button>
              </div>
            </div>
          ...
          <div className='md:flex md:h-full'>
            ...
            <div className='relative p-8 flex flex-col justify-center md:w-2/3 md:h-full z-10'>
              <div className='mb-4 flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 w-fit'>
                ...
                <span className='text-[10px] font-bold uppercase tracking-widest text-primary/80'>Recado em Destaque</span>
              </div>
              ...
              <div className='mt-auto flex flex-col sm:flex-row gap-4'>
                ...
                >
                  <Link href={`/noticias/${latestNews?.slug}`}>
                    Ler Recado <ArrowRight className='ml-2 h-4 w-4 transition-transform duration-300 group-hover/btn:translate-x-1' />
                  </Link>
                </Button>
                <Button
                  asChild
