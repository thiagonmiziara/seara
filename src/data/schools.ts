...
export const schoolsData: (CarouselItem & {
...
})[] = [
  {
    ...
    description: createDocument(
      'Capacitação e formação de líderes para o Reino de Deus.',
    ),
  ...
  },
  {
    ...
    imageUrl: '/assets/logonovabrancafundacao.png',
    logoUrl: '/assets/logonovabrancafundacao.png',
    description: createDocument(
      'Alicerce sólido na Palavra de Deus para uma vida cristã vitoriosa.',
    ),
    fullDescription: createDocument(
