  ...
  return (
    <main className='min-h-screen bg-background text-foreground'>
      <HeroSection
        ...
        title={<span className='text-primary tracking-tighter'>TEEN</span>}
        description={
          <span>
            Adolescentes vivendo uma fé{' '}
            <span className='text-primary font-semibold'>autêntica</span>e
            impactando sua geração.
          </span>
        }
      />
      ...
      <MissionSection
        ...
        title={
          <span>
            Teens <span className='text-primary'>reais</span> vivendo Cristo de
            verdade
          </span>
        }
