  ...
  return (
    <main className='min-h-screen bg-background text-foreground'>
      <HeroSection
        ...
        title={<span className='text-primary tracking-tighter'>SOMOS UM</span>}
        description={
          <span>
            Celebrando a{' '}
            <span className='text-primary font-semibold'>unidade</span>
      ...
      <MissionSection
        ...
        title={
          <span>
            Unidos em <span className='text-primary'>Cristo</span>, servindo ao
            mundo
          </span>
        }
